...
// ... rest of file
    ...
    const handleClick = (e: React.MouseEvent<HTMLDivElement>) => {
        ...
        if (addBtn) {
            ...
            newRow.innerHTML = `
                <td class="p-2 border-r border-zinc-300 border-b border-zinc-300 align-top"><div class="outline-none" contenteditable>New Service</div></td>
                <td class="p-2 border-r border-zinc-300 border-b border-zinc-300 align-top"><div class="outline-none" contenteditable>Description</div></td>
                <td class="relative p-2 border-r border-zinc-300 border-b border-zinc-300 text-center align-top">
                    <div class="pricing-cost outline-none" contenteditable>0</div>
        ...
        <div className="w-[210mm] h-[297mm] bg-white relative shadow-sm overflow-hidden flex flex-col justify-between">
            ...
            <div className={cn(
                ...
                <div 
                    ref={contentRef}
                    contentEditable
                    className="w-full h-full outline-none text-zinc-800 leading-relaxed space-y-4 hover:bg-zinc-50 focus:bg-orange-50/10 p-4 rounded overflow-hidden [&_ul]:list-none [&_ul]:pl-0 [&_ul_li]:relative [&_ul_li]:pl-5 [&_ul_li]:before:content-['•'] [&_ul_li]:before:absolute [&_ul_li]:before:left-0 [&_li]:my-1 [&_ol]:list-none [&_ol]:pl-0 [&_ol]:[counter-reset:ol-counter] [&_ol_li]:[counter-increment:ol-counter] [&_ol_li]:before:content-[counter(ol-counter)_'.'] [&_ol_li]:before:absolute [&_ol_li]:before:left-0 [&_ol_li]:relative [&_ol_li]:pl-7 [&_ol]:mb-4 [&_h1]:text-4xl [&_h1]:font-bold [&_h1]:mb-4 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mb-3 [&_h3]:text-xl [&_h3]:font-bold [&_h3]:mb-2"
